...
public class openAndSaveFileTesting extends JFrame implements ActionListener, Runnable {
    ...
    public openAndSaveFileTesting(String arg0) throws HeadlessException {
        super(arg0);
    }
    ...
    private class saveFile implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {//Writes over the existing file
                ...
                System.out.println("Error saving file '" + openedFile + "'");
            }
...
//                    System.out.println(arrOfVal[1]);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new openAndSaveFileTesting("Draw away! Make sure to save!!"));
    }
